...
<div id="searchRefineBox" class="inventaireRefineBox" style="display: none;">
    <div class="bg">
        ...
        <a href="#" id="hideRefine" onclick="jQuery('#searchRefineBox').slideUp();jQuery('#showRefine').show();"><img src="<?php print __CA_URL_ROOT__; ?>/app/plugins/museesDeFrance/assets/icons/glyphicons_191_circle_minus.png" alt="glyphicons_191_circle_minus" border="0"></a>
        <a href="#" id="hideRefine" onclick="jQuery('#inventaire_filter').submit();"><img src="<?php print __CA_URL_ROOT__; ?>/app/plugins/museesDeFrance/assets/icons/glyphicons_193_circle_ok.png" alt="glyphicons_193_circle_ok.png" border="0"></a>
