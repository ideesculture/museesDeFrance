...
<div id="searchRefineBox" style="display: none;"><div class="bg">
        ...
        <a href="#" id="hideRefine" onclick="jQuery('#searchRefineBox').slideUp();jQuery('#showRefine').show();"><img src="/app/plugins/museesDeFrance/assets/icons/glyphicons_191_circle_minus.png" alt="glyphicons_191_circle_minus" border="0"></a>
