...
?>
<h1>Transfert dans l'inventaire des biens affectés</h1>
<p>Vous avez préparé les informations de l'objet <?php print $name; ?> pour les transférer dans le registre d'inventaire.</p>
