...
<script>
    ...
    function ajax_stream()
    {
        ...
        try
        {
            ...
            console.log("<?php print __CA_URL_ROOT__; ?>/index.php/museesDeFrance/InstallProfileThesaurus/ThesaurusAlignAjax/?thesaurus=<?php print $thesaurus; ?>");
            //xhr.open("GET", "<?php print __CA_URL_ROOT__; ?>/test/ajax_stream.php", true);
            xhr.open("GET", "<?php print __CA_URL_ROOT__; ?>/index.php/museesDeFrance/InstallProfileThesaurus/ThesaurusAlignAjax/?thesaurus=<?php print $thesaurus; ?>", true);
